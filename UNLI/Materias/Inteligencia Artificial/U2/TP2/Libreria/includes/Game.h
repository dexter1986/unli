...
public:
	...
	Game(sf::VideoMode ModoVideo, std::string TextoVentana, unsigned long EstiloVentana, sf::ContextSettings ConfiguracionVentana, int fps);
	...
	//Actualiza la escena
	virtual void Actualizar(sf::Time frametTime) = 0;

	//Dibuja la escena
	virtual void Dibujar(sf::Time frametTime) = 0;
