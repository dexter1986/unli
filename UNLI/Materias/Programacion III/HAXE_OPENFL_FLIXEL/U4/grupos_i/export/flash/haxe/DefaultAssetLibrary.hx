...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/sprites_alpha.png", __ASSET__assets_images_sprites_alpha_png);
		type.set ("assets/images/sprites_alpha.png", Reflect.field (AssetType, "image".toUpperCase ()));
		...
		addExternal("assets/images/sprites_alpha.png", "image", "assets/images/sprites_alpha.png");
...
@:keep class __ASSET__assets_images_sprites_alpha_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:bitmap("assets/images/sprites_alpha.png") class __ASSET__assets_images_sprites_alpha_png extends flash.display.BitmapData {}
...
@:sound("D:/HAXE/Haxe toolkit/haxe/lib/flixel/3,3,3/assets/sounds/beep.mp3") class __ASSET__assets_sounds_beep_mp3 extends flash.media.Sound {}
@:sound("D:/HAXE/Haxe toolkit/haxe/lib/flixel/3,3,3/assets/sounds/flixel.mp3") class __ASSET__assets_sounds_flixel_mp3 extends flash.media.Sound {}
